...
pressure_file = XDMFFile('soil_heaving/pressure.xdmf')
flux_file = XDMFFile('soil_heaving/flux.xdmf')
disp_file = XDMFFile('soil_heaving/disp.xdmf')
density_file = XDMFFile('soil_heaving/density.xdmf')
porosity_file = XDMFFile('soil_heaving/porosity.xdmf')
